		...
		<>
			<section className=" bg-center sm:h-[680px] xl:h-[700px] 2xl:h-[800px]  min-h-[300px] flex items-center sm:justify-center flex-col bg-[url('/assets/header/bg-main.webp')] bg-cover ">
				...
				<div className="flex gap-10 mb-6">
					<Link
						href={"/products/all"}
						className="sm:px-6 px-3  sm:py-2 py-2 bg-orange text-white font-poppins sm:font-semibold  font-medium text-lg rounded-md mx-2 hover:bg-black hover:text-white transition-all duration-300 "
					>
						Shop All
					</Link>
					<Link
