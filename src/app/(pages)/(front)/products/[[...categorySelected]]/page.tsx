...
export default function Products() {
	return (
		<section>
			<main>
				<div className=" bg-center  h-[220px] sm:h-[340px] md:h-[400px] lg:h-[500px]  flex items-center sm:justify-center flex-col bg-[url('/assets/products/top-bg.webp')] bg-cover bg-no-repeat bg-black 2xl:w-10/12 m-auto">
